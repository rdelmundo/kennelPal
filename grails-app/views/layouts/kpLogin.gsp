...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<body>
		<div id="kpLogoMini" role="banner">
			<img src="${resource(dir: 'images', file: 'kpLogoBlockGray.png')}" alt="kpLogoBlock"/>
		</div>
		<div id="kpLoginBar">
			<img src="${resource(dir: 'images', file: 'kpLoginBar.png')}" alt="kpLoginBar"/>
		</div>
		<g:layoutBody/>
